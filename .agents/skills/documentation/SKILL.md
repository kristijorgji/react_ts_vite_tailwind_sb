...
| Rule                      | Rationale                                                         |
| ------------------------- | ----------------------------------------------------------------- |
| **Document what you own** | This repo is a React + Vite + Tailwind + Storybook boilerplate    |
| **One Getting Started**   | Root `README.md` covers setup, scripts, and troubleshooting       |
| **Agent entry**           | `AGENTS.md` points at skills and quality commands — keep it short |
...
| Env variable meanings                   | Comments in `.env.dist` + README |
